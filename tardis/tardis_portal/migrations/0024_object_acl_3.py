...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ObjectACL.experiment'
        db.delete_column('tardis_portal_objectacl', 'experiment_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ObjectACL.experiment'
        raise RuntimeError("Cannot reverse this migration. 'ObjectACL.experiment' and its values cannot be restored.")
