...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'DatafileParameter', fields ['numerical_value']
        ...
        # Adding index on 'DatasetParameter', fields ['numerical_value']
        ...
        # Adding index on 'ExperimentParameter', fields ['numerical_value']
        db.create_index('tardis_portal_experimentparameter', ['numerical_value'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'ExperimentParameter', fields ['datetime_value']
        ...
        # Removing index on 'DatasetParameter', fields ['datetime_value']
        ...
        # Removing index on 'DatafileParameter', fields ['datetime_value']
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 29)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
