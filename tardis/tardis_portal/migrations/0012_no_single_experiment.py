...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dataset.experiment'
        db.delete_column('tardis_portal_dataset', 'experiment_id')


    def backwards(self, orm):
        # Adding field 'Dataset.experiment'
        db.add_column('tardis_portal_dataset', 'experiment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tardis_portal.Experiment']),
                      keep_default=False)
