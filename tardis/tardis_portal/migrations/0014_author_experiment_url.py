...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author_Experiment.url'
        db.add_column('tardis_portal_author_experiment', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author_Experiment.url'
        db.delete_column('tardis_portal_author_experiment', 'url')
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
