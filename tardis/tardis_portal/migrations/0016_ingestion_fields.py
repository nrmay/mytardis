...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset_File.sha512sum'
        db.add_column('tardis_portal_dataset_file', 'sha512sum',
    ...
    def backwards(self, orm):
        # Deleting field 'Dataset_File.sha512sum'
        db.delete_column('tardis_portal_dataset_file', 'sha512sum')
